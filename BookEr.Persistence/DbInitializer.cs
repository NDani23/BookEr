...
namespace BookEr.Persistence
{
    public static class DbInitializer
    {
        ...
        public static async Task Initialize(BookerDbContext context, string imageDirectory, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole<int>> roleManager)
        {
            ...
            await SeedVisitorsAndBorrows(imageDirectory);
            await SeedLibrarians();
        ...
        private static async Task SeedVisitorsAndBorrows(String imgDir)
        {
        ...
        private static async Task SeedLibrarians()
        {
            var AppUser = new ApplicationUser();
